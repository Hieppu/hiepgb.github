    ...
    switch (action.type) {
        ...
        case actionTypes.CHANGE_PASSWORD_FAIL:
            return {
                ...state,
                isLoading: false,
                errorMessageForgotPassword: action.payload,
            }
        ...
        case actionTypes.FORGOT_PASSWORD_SUCCESS:
            return {
                ...state,
                isLoading: false,
                messageForgotPasswordSuccess: 'Your submit username success. Please re-active account by click the link which our system has just send to your email.'
            }
